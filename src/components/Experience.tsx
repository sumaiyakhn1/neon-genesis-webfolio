...
const experiences = [
  {
    ...
    description: "Currently working as an Implementation Engineer at Okie Dokie, where I am gaining practical experience in software development and contributing to various projects, enhancing my skills in a real-world environment.",
  },
  {
    id: 2,
    ...
    description: "Worked as an Engineer Trainee at Okie Dokie, gaining practical experience in software development and contributing to various projects, enhancing my skills in a real-world environment.",
  },
  {
    id: 3,
